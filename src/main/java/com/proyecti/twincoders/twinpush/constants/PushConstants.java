...
public final class PushConstants {
	...
	public static final String TWINPUSH_APP_VERSION = "v1";
	...
	public static final String TWINPUSH_URL_ONE_PUSH_NOTIFICATION = TWINPUSH_URL_PREFIX + "/devices/" + TWINPUSH_DEVICE_ID_PARAM + "/notifications";
